...
export const UserActivityMonitor: React.FC = () => {
  ...
  if (!activityData) {
    return (
      <div className="space-y-6">
        <div className="bg-slate-800/50 backdrop-blur-md rounded-lg p-8 border border-slate-700/50 text-center">
      ...
      <div className="bg-slate-800/50 backdrop-blur-md rounded-lg p-6 border border-slate-700/50">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-1">Real-time user activity tracking and analytics</p>
          </div>
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                  timeRange === range
                    ...
                    : 'bg-slate-700/30 border border-slate-600 text-slate-400 hover:bg-slate-700/50 hover:border-slate-500 hover:text-slate-300'
                }`}
              >
          ...
          <div className="space-y-3">
            {activityData.recentActivity.length === 0 ? (
              ...
              activityData.recentActivity.map((event) => (
                <div key={event.id} className="flex items-center gap-3 p-3 rounded-lg bg-slate-700/30 border border-slate-600/50">
          ...
          <div className="space-y-3">
            {activityData.popularDocuments.length === 0 ? (
              ...
              activityData.popularDocuments.map((doc, index) => (
                <div key={doc.id} className="flex items-center gap-3 p-3 rounded-lg bg-slate-700/30 border border-slate-600/50">
        ...
        <div className="h-64 flex items-end justify-between gap-2">
          {activityData.userGrowth.map((data, index) => (
            <div key={index} className="flex-1 flex flex-col items-center">
              <div className="w-full bg-slate-700 rounded-t">
                <div 
